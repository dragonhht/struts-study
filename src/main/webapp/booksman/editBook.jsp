...
<body>
	<html:form action="/bookman.do?method_=updateBook">
	<input type="text" name="id" value="${book.id }" hidden="hidden" />
		<table border="1" >
			<tr>
				<td>图书名称:</td>
				<td> <html:text property="bookName" value="${book.bookName }"></html:text>   </td>
			</tr>

			<tr>
				<td>图书价格:</td>
				<td> <html:text property="bookPrice" value="${book.bookPrice }"></html:text>   </td>
			</tr>
			...
			<%-- <tr>
				<td>图书所在图书馆</td>
				<td> <html:text property="bookHome" value="${book.bookHome }"></html:text>    </td>
			</tr> --%>
			
			<tr>
				<td>图书馆列表</td>
				<td>
					<html:select property="homeId" value="${book.homeId }">
			...
			<tr>
				<td>图书简介</td>
				<td> <html:textarea property="bookMarks" cols="40" rows="8" value="${book.bookMarks }"></html:textarea>    </td>
			</tr>
